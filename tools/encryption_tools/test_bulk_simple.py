#!/usr/bin/env python3
"""
Simple tests for bulk encryption functionality
"""
...
class TestBulkEncryptionCore(unittest.TestCase):
    """Test core bulk encryption functionality"""
    ...
    def test_string_encryption_decryption(self):
        ...
        for test_string in test_strings:
            with self.subTest(string=test_string):
                ...
                # Base64 might not always have padding, so just check it's valid base64
                try:
    ...
    def test_bulk_encryption_workflow(self):
        ...
        actual_encrypted_files = list(self.output_folder.glob('*.enc'))
        self.assertEqual(len(actual_encrypted_files), len(encrypted_files))
        
        # Verify the filenames match what we generated
